...
class _DeviceListState extends State<_DeviceList> {
  ...
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          title: const Text('Busqueda de dispositivos'),
          centerTitle: true,
        ),
        body: Column(
          children: [
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text('Buscar por UUID (2, 4, 16 bytes):'),
                  TextField(
                    ...
                    children: [
                      Expanded(
                        child: Text(!widget.scannerState.scanIsInProgress
                            ? 'Captura UUID valido para realizar una busqueda especifica'
                      ...
                      if (widget.scannerState.scanIsInProgress ||
                        ...
                        Padding(
                          ...
                          child: Text(
                              'Dispositivos: ${widget.scannerState.discoveredDevices.length}'),
                        ),
                    ],
                  ),
                ],
